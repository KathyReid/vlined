...
/*
// ACKNOWLEDGEMENT
GITHUB.COM/JEMJABELLA - MANY THANKS JEM
*/
// OPTIONS - PLEASE CONFIGURE THESE BEFORE USE!

$yourEmail = "kathy@kathyreid.id.au"; // the email address you wish to receive these mails through
$yourWebsite = "vlined.net"; // the name of your website
$thanksPage = 'suggestion-thanks.html'; // URL to 'thanks for sending mail' page; leave empty to keep message on the same page 
$maxPoints = 4; // max points a person can hit before it refuses to submit - recommend 4
$requiredFields = "excuseSuggestion"; // names of the fields you'd like to be required as a minimum, separate each field with a comma
